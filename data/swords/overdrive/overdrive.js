/**
 * Overdrive Sword Data
 * Second Weapon: 7 Progressive Phases (Speed Theme, 50 to 300 SPD).
 */
(function(window) {
  ...
  window.Killstreak.Data.Swords.overdrive = {
    id: "overdrive",
    name: "Overdrive",
    tag: "SPEED WEAPON",
    icon: "⚡",
