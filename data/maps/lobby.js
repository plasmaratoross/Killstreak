...
(function(window) {
  ...
  const LOBBY_MAP = {
    ...
    height: 1100,
    spawn: { x: 450, y: 650 },
    // Compact Upper-Left Row Exhibition: Devourer, Overdrive, Aquatic (57.5px spacing, 75% reduced)
    swordStands: [
      {
        id: "devourer_stand",
        swordId: "devourer",
    ...
    // Lounge Furniture (Box Obstacles)
    furniture: [
      {
        id: "sofa_main",
        x: 900,
      ...
      },
      {
        ...
        height: 180,
        type: "credenza",
        label: "Lounge Console"
      }
    ],
    // Potted Greenery (Circular Obstacles)
    plants: [
    ...
    // Warm Floor Lamps (Circular Obstacles with Radial Light Pools)
    lamps: [
  ...
  window.Killstreak.Data.Maps.LOBBY = LOBBY_MAP;
})(window);
