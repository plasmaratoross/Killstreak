...
export const libTabLumen = document.getElementById("lib-tab-lumen");
export const libTabUmbra = document.getElementById("lib-tab-umbra");
export const libTabSanguine = document.getElementById("lib-tab-sanguine");
export const libTabOrder = document.getElementById("lib-tab-order");
export const libTabTremor = document.getElementById("lib-tab-tremor");
export const libTabPoison = document.getElementById("lib-tab-poison");
